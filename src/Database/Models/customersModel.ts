...
export interface CustomerOutput extends Required<CustomerAttributes> { }; //Saída com o objeto completo!
...
Customer.init({
  ...
  sequelize,
  modelName: "customers", //nome da tabela no banco de dados
  paranoid: true, // esta tabela exclui no formato logico
});

Employees.hasMany(Customer, { foreignKey: "salesRepEmployeeNumber" });
Customer.belongsTo(Employees, { foreignKey: "salesRepEmployeeNumber" });
